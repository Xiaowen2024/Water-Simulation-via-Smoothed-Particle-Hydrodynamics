#ifndef CGL_LIQUID_SIMULATOR_H
#define CGL_LIQUID_SIMULATOR_H
...
public:
  LiquidSimulator(std::string project_root, Screen *screen);
  ~LiquidSimulator();

  void init();

  void loadLiquid(Liquid *liquid);
  void loadLiquidParameters(LiquidParameters *lp);
